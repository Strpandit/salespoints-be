class Role < ApplicationRecord
  ...
  ALLOWED_MODULES = %w[ accounts account_deletion_requests admin_deletion_requests admin_users roles brands categories dealers dealer_locations dealer_profiles dealer_products products reviews notifications orders analytics settings dealer_deletion_requests wholesaler_posts payouts payout_requests ]
